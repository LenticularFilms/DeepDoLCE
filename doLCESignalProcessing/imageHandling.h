...
int regularize_peakRaster_mod( glProfile_t *glProfile, float lensWidth, int *nPeaks ); /// new attempt to improve raster regularization

int regularize_peakRaster( glProfile_t *glProfile, int rasterSpacing, int *nPeaks ); // rebame Raster to Profile, dito below!!!!!

int relax_regPeakRaster_mod( glProfile_t *glProfile, glProfile_t *regPeakProfile, int maxDist ); //////// new attempt for proper working relaxation algorithm
